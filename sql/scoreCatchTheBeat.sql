DROP TABLE IF EXISTS scoreCatchTheBeat;

CREATE TABLE scoreCatchTheBeat (
    ...
    maximum_statistics_large_tick_hit INTEGER NOT NULL,
    maximum_statistics_small_tick_hit INTEGER NOT NULL,
    mods JSONB NOT NULL,
