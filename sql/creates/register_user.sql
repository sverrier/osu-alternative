-- DROP PROCEDURE public.register_user(int8);

CREATE OR REPLACE PROCEDURE public.register_user(IN p_user_id bigint)
 LANGUAGE plpgsql
AS $procedure$
BEGIN
	------------------------------------------------------------------------
...
ALTER PROCEDURE public.register_user(int8) OWNER TO postgres;
GRANT ALL ON PROCEDURE public.register_user(int8) TO postgres;
