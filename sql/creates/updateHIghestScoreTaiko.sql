...
BEGIN
    ...
    SELECT
        ...
        s.maximum_statistics_large_bonus, s.maximum_statistics_small_bonus,
        s.maximum_statistics_ignore_hit, s.mods, s.passed, s.pp, s.preserve, s.processed,
        s.rank, s.ranked, s.replay, s.ruleset_id, s.started_at, s.statistics_great,
        s.statistics_ok, s.statistics_miss, s.statistics_large_bonus, s.statistics_ignore_hit,
        s.statistics_ignore_miss, s.statistics_small_bonus, s.total_score,
