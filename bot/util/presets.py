...
LEADERBOARD_PRESETS = {
    ...
    "extraclears": {
        ...
        "-difficulty_reducing": "false",
        "-grade-notin": "b,c,d",
        "-total_score-min": "700000",
        "title": "Total extra clears",
        "description": "Counts distinct clears per user with high requirements: no difficulty-removing/reducing mods, grade must NOT be B/C/D (so A/S/SS-tier), and total_score must be at least 700,000.",
    },
    "ultraclears": {
        "columns": "username, COUNT(DISTINCT beatmap_id)",
        "-group": "username",
