...
LEADERBOARD_PRESETS = {
    ...
    "hardclears": {
        ...
        "-difficulty_reducing": "false",
        "-accuracy-min": "0.85",
        "-total_score-min": "350000",
        "title": "Total hard clears",
        "description": "Counts distinct clears per user with stricter requirements: no difficulty-removing/reducing mods, grade must NOT be C or D, and total_score must be at least 350,000.",
    },
    "extraclears": {
        "columns": "username, COUNT(DISTINCT beatmap_id)",
        "-group": "username",
        ...
        "-difficulty_reducing": "false",
        "-accuracy-min": "0.94",
        "-total_score-min": "550000",
        "title": "Total extra clears",
        "description": "Counts distinct clears per user with high requirements: no difficulty-removing/reducing mods, grade must NOT be B/C/D, and total_score must be at least 550,000.",
    },
    "ultraclears": {
        "columns": "username, COUNT(DISTINCT beatmap_id)",
        "-group": "username",
        ...
        "description": "Counts distinct clears per user with very strict requirements: no difficulty-removing/reducing mods, accuracy must be at least 96%, and total_score must be at least 750,000.",
    },
    "overclears": {
        "columns": "username, COUNT(DISTINCT beatmap_id)",
        "-group": "username",
        ...
        "-difficulty_reducing": "false",
        "-accuracy-min": "0.99",
        "-total_score-min": "925000",
        "-is_fc": "true",
        "title": "Total overclears",
        "description": "Counts distinct clears per user at the top tier: no difficulty-removing/reducing mods, accuracy must be 99 or above, and total_score must be at least 925,000. Play must an FC.",
    },
    "fc": {
        "columns": "username, COUNT(DISTINCT beatmap_id)",
        "-group": "username",
